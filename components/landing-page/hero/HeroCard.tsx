...
export const HeroCard: React.FC<HeroCardProps> = ({}) => {
  return (
    <div className="w-full bg-cardGray flex flex-col sm:flex-row sm:gap-5 justify-start items-center p-8 lg:py-3 rounded-2xl mt-5 md:mt-11 lg:mt-0 lg:mb-8 xl:mb-0 drop-shadow-lg md:col-span-2 lg:col-span-1">
